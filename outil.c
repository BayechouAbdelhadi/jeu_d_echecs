...
void Traducteur(int code, char temp[]){ /*chaque piece du plateau se voit attribue une valeur unique, un int
                                            la fonction � partir de cet int remplit uun tableau de char pour donner une
                                            valeur intuitive de la piece ex: 210 ->nP0 (pion noir n�0*/
...
void Afficher(int Plateau[][8],char *nom1,char *nom2,int couleur,int visu,int n_Partie){/*appelle la fonction traducteur pour donner un plateau compr�hensible*/
    int j,i,coloration;
    printf("                                PARTIE %d                             \n\n",n_Partie);
